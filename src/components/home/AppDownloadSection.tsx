...
export function AppDownloadSection({ data }: AppDownloadSectionProps) {
  ...
  const discountCode = acf.discount_code?.trim();
  ...
  return (
    <section className="relative isolate z-[100] w-full overflow-x-hidden overflow-y-visible bg-[#226d71] py-16">
      ...
      <div className="relative z-10 mx-auto w-full max-w-4xl px-6">
        {/* Left-aligned content: heading, sub-heading, discount code only */}
        ...
        {/* Full-width row: store buttons side by side below the two columns */}
